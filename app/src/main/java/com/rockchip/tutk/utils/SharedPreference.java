...
import com.rockchip.tutk.app.BaseApplication;
...
public class SharedPreference {
    ...
    public static void putInt(String key, int value) {
        putInt(getApplicationContext(), key, value);
    }
    ...
    public static void putBoolean(String key, boolean value) {
        putBoolean(getApplicationContext(), key, value);
    }
    ...
    public static void putString(String key, String value) {
        putString(getApplicationContext(), key, value);
    }
    ...
    public static void putFloat(String key, float value) {
        putFloat(getApplicationContext(), key, value);
    }
    ...
    public static void putLong(String key, long value) {
        putLong(getApplicationContext(), key, value);
    }
    ...
    public static int getInt(String key, int defValue) {
        return getInt(getApplicationContext(), key, defValue);
    }
    ...
    public static boolean getBoolean(String key, boolean defValue) {
        return getBoolean(getApplicationContext(), key, defValue);
    }
    ...
    public static String getString(String key, String defValue) {
        return getString(getApplicationContext(), key, defValue);
    }
    ...
    public static float getFloat(String key, float defValue) {
        return getFloat(getApplicationContext(), key, defValue);
    }
    ...
    public static long getLong(String key, long defValue) {
        return getLong(getApplicationContext(), key, defValue);
    }
