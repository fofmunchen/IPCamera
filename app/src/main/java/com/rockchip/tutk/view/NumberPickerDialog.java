...
public class NumberPickerDialog extends AlertDialog implements OnClickListener {
    ...
    public NumberPickerDialog(Context context,
                              ...
                              int rangeMax,
                              int title) {
        this(context, AlertDialog.THEME_HOLO_LIGHT, callBack, number,0, rangeMin, rangeMax, title);
    }
    ...
    public NumberPickerDialog(Context context,
                              ...
                              int rangeMax,
                              int title) {
        this(context, AlertDialog.THEME_HOLO_LIGHT, callBack, number,step, rangeMin, rangeMax, title);
    }
    ...
    public NumberPickerDialog(Context context,
        ...
        super(context, theme);
        mCallback = callBack;
        //context.setTheme(R.style.Theme_Holo_Light_Dialog_Alert);
        setTitle(title);
        ...
        mNumberPicker.setOnValueChangedListener(new NumberPicker.OnValueChangeListener() {
            ...
            public void onValueChange(NumberPicker numberPicker, int oldVal, int newVal) {
                if (step > 0&& Math.abs(oldVal - newVal)<step){
                    mNumberPicker.setValue((newVal < oldVal)?oldVal-step:oldVal+step);
                }else{
